...
DOCS_DELETE = "documents/delete_by_filters"
DOCS_WRITE = "documents/write"
...
def reset_datastore(filters={}):
    """
    Delete documents in the datastore
    """
    url = f"{API_ENDPOINT}/{DOCS_DELETE}"
    params = {"filters": filters}
    response_raw = requests.post(url, json=params)
...
def index_datastore(documents):
    """
    Index documents in the datastore
    """
    url = f"{API_ENDPOINT}/{DOCS_WRITE}"
    requests.post(url, json=documents)
